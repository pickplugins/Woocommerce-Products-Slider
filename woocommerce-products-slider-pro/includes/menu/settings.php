	...
	<div class="para-settings">
		...
		<ul class="box">
            ...
            <li style="display: block;" class="box1 tab-box active">
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Optimize CSS & Scripts file load by page', wcps_textdomain); ?></p>
                    <p class="option-info"><?php _e('Please use page ids where you using shortcode <code>[wcps id="123"]</code>Use comma separate value. ex: 12,14', wcps_textdomain); ?></p>

                    <textarea placeholder="12,14,15" name="wcps_load_script_pages"><?php echo $wcps_load_script_pages; ?></textarea>
    ...
    if(wcps_customer_type=="free")
        {
			...
			echo sprintf(__('You are using <strong>%s version %s </strong> of <strong>%s</strong> To get more feature you could try our premium version.', wcps_textdomain), wcps_customer_type, wcps_plugin_version, wcps_plugin_name);
        ...
        {
    		echo sprintf(__('Thanks for using <strong> premium version %s </strong> of <strong>%s</strong>.', wcps_textdomain), wcps_plugin_version, wcps_plugin_name);
