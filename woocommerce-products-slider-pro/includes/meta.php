...
function meta_boxes_wcps_input( $post ) {
	...
	$wcps_rows_enable = get_post_meta( $post->ID, 'wcps_rows_enable', true );
	if(empty($wcps_rows_enable)){
		$wcps_rows_enable = 'false';
	}

	$wcps_rows_desktop = get_post_meta( $post->ID, 'wcps_rows_desktop', true );
	if(empty($wcps_rows_desktop)){
		$wcps_rows_desktop = 2;
	}

	$wcps_rows_tablet = get_post_meta( $post->ID, 'wcps_rows_tablet', true );
	if(empty($wcps_rows_tablet)){
		$wcps_rows_tablet = 1;
	}

	$wcps_rows_mobile = get_post_meta( $post->ID, 'wcps_rows_mobile', true );
  ...
  $wcps_slideBy = get_post_meta( $post->ID, 'wcps_slideBy', true );
	if(empty($wcps_slideBy)){$wcps_slideBy = 1;}
	...
	$wcps_meta_query = get_post_meta( $post->ID, 'wcps_meta_query', true );
	if(empty($wcps_meta_query)){$wcps_meta_query = array(); }

	$wcps_meta_query_relation = get_post_meta( $post->ID, 'wcps_meta_query_relation', true );
	...
	$wcps_product_categories = get_post_meta( $post->ID, 'wcps_product_categories', true );


	$wcps_more_query = get_post_meta( $post->ID, 'wcps_more_query', true );
	...
	$wcps_product_only_discounted = get_post_meta( $post->ID, 'wcps_product_only_discounted', true );
	if(empty($wcps_product_only_discounted)){$wcps_product_only_discounted = 'no'; }


	$wcps_product_filter_by = get_post_meta( $post->ID, 'wcps_product_filter_by', true );
	if(empty($wcps_product_filter_by)){$wcps_product_filter_by = 'none'; }



	$wcps_product_best_selling = get_post_meta( $post->ID, 'wcps_product_best_selling', true );
	...
	$wcps_product_sku = get_post_meta( $post->ID, 'wcps_product_sku', true );
	$wcps_upsells_crosssells = get_post_meta( $post->ID, 'wcps_upsells_crosssells', true );

	if(empty($wcps_upsells_crosssells)) $wcps_upsells_crosssells = 'none';
    ...
    $wcps_items_thumb_link_to_meta_value = get_post_meta( $post->ID, 'wcps_items_thumb_link_to_meta_value', true );
    $wcps_items_thumb_link_target = get_post_meta( $post->ID, 'wcps_items_thumb_link_target', true );
	...
	$wcps_items_cat_separator = get_post_meta( $post->ID, 'wcps_items_cat_separator', true );
	...
	$wcps_cart_text = get_post_meta( $post->ID, 'wcps_cart_text', true );
	...
	$wcps_cart_display_quantity = get_post_meta( $post->ID, 'wcps_cart_display_quantity', true );
    ...
    <div class="para-settings">
		...
		<ul class="box">
            ...
            <li style="display: none;" class="box2 tab-box">
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Slider row enable', wcps_textdomain);?></p>

                    <select name="wcps_rows_enable">
                        <option value="true" <?php if(($wcps_rows_enable=="true")) echo "selected"; ?> ><?php _e('True', wcps_textdomain);?></option>
                        <option value="false" <?php if(($wcps_rows_enable=="false")) echo "selected"; ?> ><?php _e('False', wcps_textdomain);?></option>
                    </select>

                    <p class="option-title"><?php _e('Slider rows', wcps_textdomain);?></p>
                    <p class="option-info"><?php _e('In Desktop: (min:1000px and max)', wcps_textdomain);?></p>
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Slider Settings', wcps_textdomain);?></p>
                    ...
                    <input type="text" placeholder="1000" id="wcps_auto_play_speed" name="wcps_auto_play_speed" value="<?php echo $wcps_auto_play_speed; ?>"  />

                    <p class="option-info"><?php _e('Slider Auto Play Timeout','woocommerce-products-slider');?></p>
                    <input type="text" placeholder="1000" id="wcps_auto_play_timeout" name="wcps_auto_play_timeout" value="<?php echo $wcps_auto_play_timeout; ?>"  />

                    <p class="option-info"><?php _e('Slider Slideby Count','woocommerce-products-slider');?></p>
                    <input type="text" placeholder="3" id="wcps_slideBy" name="wcps_slideBy" value="<?php echo $wcps_slideBy; ?>"  />
            ...
            <li style="display: none;" class="box4 tab-box ">
				...
				<div class="option-box">
                    ...
                    <p class="option-info"><?php _e('ex: 10', wcps_textdomain);?></p>
					<input type="text" placeholder="10"   name="wcps_total_items" value="<?php echo $wcps_total_items; ?>" />
                </div>


				<div class="option-box">
                    <p class="option-title"><?php _e('Product Terms', wcps_textdomain);?></p>
                    <p class="option-info"><?php _e('Select product categories & terms', wcps_textdomain);?></p>
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Meta query', wcps_textdomain); ?></p>
                    <p class="option-info"><?php _e('query post by meta key & value, Reference:  https://codex.wordpress.org/Class_Reference/WP_Query#Custom_Field_Parameters', wcps_textdomain); ?></p>

                    <div class="meta-query-list expandable">
                    <?php

					//var_dump($wcps_meta_query);
                    ...
                    <p class="option-title"><?php _e('Meta query relation', wcps_textdomain); ?></p>
                    <label><input type="radio" name="wcps_meta_query_relation" <?php if($wcps_meta_query_relation == 'OR') echo 'checked';?> value="OR" ><?php _e('OR', wcps_textdomain); ?></label>
                    <label><input type="radio" name="wcps_meta_query_relation" <?php if($wcps_meta_query_relation == 'AND') echo 'checked';?> value="AND" ><?php _e('AND', wcps_textdomain); ?></label>
				...
				<div class="option-box">
                    <p class="option-title"><?php _e('More Query', wcps_textdomain);?></p>

                    <p class="option-info"><?php _e('More query parameter, ex: <b>year=2016&monthnum=02</b> <br /> you can provide array like this, post__in=96,97 keep the last comma to avoid error.', wcps_textdomain);?></p>
                    <textarea name="wcps_more_query" ><?php echo $wcps_more_query;?></textarea>
                    ...
                    <p class="option-info"><?php _e('Only discounted', wcps_textdomain);?></p>
					<label><input <?php if($wcps_product_only_discounted=="yes")  echo "checked";?> type="radio" name="wcps_product_only_discounted" value="yes" />Yes</label>
					<label><input <?php if($wcps_product_only_discounted=="no")  echo "checked";?> type="radio" name="wcps_product_only_discounted" value="no" />No</label>




                    <p class="option-info"><?php _e('Best Selling Product display', wcps_textdomain);?></p>
					<label><input <?php if($wcps_product_best_selling=="yes")  echo "checked";?> type="radio" name="wcps_product_best_selling" value="yes" />Yes</label>
					<label><input <?php if($wcps_product_best_selling=="no")  echo "checked";?> type="radio" name="wcps_product_best_selling" value="no" />No</label>

                    <p class="option-info"><?php _e('Product filter by', wcps_textdomain);?></p>
                    <label><input type="radio" <?php if($wcps_product_filter_by=="none")  echo "checked";?> name="wcps_product_filter_by" value="none" />None</label><br />
                    <label><input type="radio" <?php if($wcps_product_filter_by=="top_rated")  echo "checked";?> name="wcps_product_filter_by" value="top_rated" />Top Rated</label><br />                  <label><input type="radio" <?php if($wcps_product_filter_by=="recently_viewed")  echo "checked";?> name="wcps_product_filter_by" value="recently_viewed" />Recently Viewed</label>  <br />
                    <label><input type="radio" <?php if($wcps_product_filter_by=="featured_first")  echo "checked";?> name="wcps_product_filter_by" value="featured_first" />Featured product at first</label><br />




                    <p class="option-info"><?php _e('Product display by Product ID', wcps_textdomain);?></p>
					<input type="text" size="7" class="wcps_product_ids" name="wcps_product_ids" value="<?php echo $wcps_product_ids;?>" placeholder="45,23,85" />

                    <p class="option-info"><?php _e('Product display by SKU, use (,) comma separted', wcps_textdomain);?></p>
					<input type="text" size="7" class="wcps_product_sku" name="wcps_product_sku" value="<?php echo $wcps_product_sku;?>" placeholder="" />


                    <p class="option-info"><?php _e('Show Upsells, Cross-sells Product, this only work in single product page', wcps_textdomain);?></p>
                    <label><input <?php if($wcps_upsells_crosssells =="none")  echo "checked";?> type="radio" name="wcps_upsells_crosssells" value="none" />None</label>
                    <label><input <?php if($wcps_upsells_crosssells =="upsells")  echo "checked";?> type="radio" name="wcps_upsells_crosssells" value="upsells" />Upsells</label>
                    <label><input <?php if($wcps_upsells_crosssells =="cross_sells")  echo "checked";?> type="radio" name="wcps_upsells_crosssells" value="cross_sells" />Cross-sells</label>
                    <label><input <?php if($wcps_upsells_crosssells =="both")  echo "checked";?> type="radio" name="wcps_upsells_crosssells" value="both" />Both</label>
				...
				<div class="option-box">
                    ...
                    <select name="wcps_query_orderby" >
                        ...
                        <option value="meta_value_num" <?php if($wcps_query_orderby=="meta_value_num") echo "selected"; ?>><?php _e('Meta Value(Number)', wcps_textdomain);?></option>                                <option value="post__in" <?php if($wcps_query_orderby=="post__in") echo "selected"; ?>><?php _e('post__in', wcps_textdomain);?></option>
                    </select>
...
function meta_boxes_wcps_save( $post_id ) {
  ...
  // Sanitize user input.
	...
	$wcps_meta_query = isset($_POST['wcps_meta_query']) ? stripslashes_deep( $_POST['wcps_meta_query'] ) :'';
	$wcps_meta_query_relation = sanitize_text_field( $_POST['wcps_meta_query_relation'] );
	...
	$wcps_rows_enable = sanitize_text_field( $_POST['wcps_rows_enable'] );
	$wcps_rows_desktop = sanitize_text_field( $_POST['wcps_rows_desktop'] );
	$wcps_rows_tablet = sanitize_text_field( $_POST['wcps_rows_tablet'] );
	$wcps_rows_mobile = sanitize_text_field( $_POST['wcps_rows_mobile'] );
	...
	$wcps_more_query = sanitize_text_field( $_POST['wcps_more_query'] );
	...
	$wcps_product_only_discounted = sanitize_text_field( $_POST['wcps_product_only_discounted'] );
	$wcps_product_filter_by = sanitize_text_field( $_POST['wcps_product_filter_by'] );

	$wcps_product_best_selling = sanitize_text_field( $_POST['wcps_product_best_selling'] );
	$wcps_product_ids = sanitize_text_field( $_POST['wcps_product_ids'] );
	$wcps_product_sku = sanitize_text_field( $_POST['wcps_product_sku'] );
	$wcps_upsells_crosssells = sanitize_text_field( $_POST['wcps_upsells_crosssells'] );
	...
	$wcps_cart_text = sanitize_text_field( $_POST['wcps_cart_text'] );
    ...
    $wcps_items_thumb_link_to_meta_value = sanitize_text_field( $_POST['wcps_items_thumb_link_to_meta_value'] );
  ...
  // Update the meta field in the database.
	...
	update_post_meta( $post_id, 'wcps_meta_query', $wcps_meta_query );
	update_post_meta( $post_id, 'wcps_meta_query_relation', $wcps_meta_query_relation );
	...
	update_post_meta( $post_id, 'wcps_rows_enable', $wcps_rows_enable );
	update_post_meta( $post_id, 'wcps_rows_desktop', $wcps_rows_desktop );
	update_post_meta( $post_id, 'wcps_rows_tablet', $wcps_rows_tablet );
	update_post_meta( $post_id, 'wcps_rows_mobile', $wcps_rows_mobile );
  ...
  update_post_meta( $post_id, 'wcps_slideBy', $wcps_slideBy );
	...
	update_post_meta( $post_id, 'wcps_more_query', $wcps_more_query );
	...
	update_post_meta( $post_id, 'wcps_product_filter_by', $wcps_product_filter_by );
	update_post_meta( $post_id, 'wcps_product_best_selling', $wcps_product_best_selling );
	update_post_meta( $post_id, 'wcps_product_ids', $wcps_product_ids );
	update_post_meta( $post_id, 'wcps_product_sku', $wcps_product_sku );
	update_post_meta( $post_id, 'wcps_upsells_crosssells', $wcps_upsells_crosssells );
	...
	update_post_meta( $post_id, 'wcps_cart_text', $wcps_cart_text );
