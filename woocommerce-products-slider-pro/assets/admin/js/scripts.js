...
jQuery(document).ready(function($)
	{
		...
		$(document).on('click', '#wcps_metabox .add-meta-query', function()
			{
				...
				data: {"action": "wcps_meta_query_add","key":key},
				success: function(data)
						{	

							jQuery("#wcps_metabox .meta-query-list").append(data);
		...
		$(document).on('click', '#wcps_metabox .meta-query-list .remove', function()
			{
